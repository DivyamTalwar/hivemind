...
import { readFileSync, writeFileSync, mkdirSync as mkdirSync2, unlinkSync, renameSync } from "node:fs";
...
import { readFileSync as readFileSync4, writeFileSync as writeFileSync2, writeSync, mkdirSync as mkdirSync3, existsSync as existsSync2, unlinkSync as unlinkSync2, openSync, closeSync, statSync } from "node:fs";
...
function spawnHermesWikiWorker(opts) {
  ...
  const tmpDir = join9(tmpdir(), `deeplake-wiki-${sessionId}-${Date.now()}`);
...
import { writeFileSync as writeFileSync4, mkdirSync as mkdirSync6, appendFileSync as appendFileSync3, chmodSync } from "node:fs";
...
import { readFileSync as readFileSync6, writeFileSync as writeFileSync5, writeSync as writeSync2, mkdirSync as mkdirSync7, renameSync as renameSync3, rmdirSync, existsSync as existsSync5, lstatSync, unlinkSync as unlinkSync3, openSync as openSync2, closeSync as closeSync2 } from "node:fs";
...
import { existsSync as existsSync6, mkdirSync as mkdirSync8, readFileSync as readFileSync7, writeFileSync as writeFileSync6 } from "node:fs";
