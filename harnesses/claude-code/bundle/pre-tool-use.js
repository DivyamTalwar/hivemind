...
import { existsSync as existsSync3, lstatSync, mkdirSync as mkdirSync3, readFileSync as readFileSync4, renameSync as renameSync3, unlinkSync as unlinkSync2, writeFileSync as writeFileSync2 } from "node:fs";
import { dirname as dirname4, join as join7 } from "node:path";

// dist/src/skillify/legacy-migration.js
import { existsSync as existsSync2, renameSync as renameSync2 } from "node:fs";
...
function migrateLegacyStateDir() {
  ...
  const legacy = join6(dirname3(current), "skilify");
...
function queuePath() {
  return join8(homedir5(), ".deeplake", "notifications-queue.json");
}
function lockPath() {
...
async function withQueueLock(fn) {
  ...
  mkdirSync4(join8(homedir5(), ".deeplake"), { recursive: true, mode: 448 });
  let fd = null;
