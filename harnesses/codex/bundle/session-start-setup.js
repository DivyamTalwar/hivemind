...
import { delimiter as delimiter2, join as join11 } from "node:path";
...
function getInstalledVersion(bundleDir, pluginManifestDir) {
  ...
  try {
    const stamp = readFileSync7(join12(bundleDir, "..", ".hivemind_version"), "utf-8").trim();
    if (stamp)
      return stamp;
  } catch {
  }
...
var { log: wikiLog } = makeWikiLogger(join13(homedir7(), ".codex", "hooks"));
