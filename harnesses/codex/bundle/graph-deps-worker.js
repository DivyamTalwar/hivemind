...
import { existsSync as existsSync4, mkdirSync as mkdirSync3, readFileSync as readFileSync4, rmSync as rmSync3, statSync as statSync2, utimesSync, writeFileSync as writeFileSync3 } from "node:fs";
...
import { copyFileSync, chmodSync, existsSync as existsSync3, lstatSync as lstatSync2, readdirSync as readdirSync2, readFileSync as readFileSync3, readlinkSync, rmSync as rmSync2, statSync, unlinkSync as unlinkSync2 } from "node:fs";
...
function clearAttempt(attemptFile) {
  try {
    rmSync3(attemptFile, { force: true });
  } catch {
  }
}
